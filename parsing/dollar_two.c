...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/18 18:21:36 by gbroccol          #+#    #+#             */
/*   Updated: 2020/11/18 18:27:10 by gbroccol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static int		dollar_two_middle(t_all *all, char *line, t_pars *ps)
{
	int			ret;
...
int				dollar_two(t_all *all, char *line, t_pars *ps)
{
	...
	{
		return (dollar_two_middle(all, line, ps));
	}
	return (0);
}
